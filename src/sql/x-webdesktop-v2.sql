...
--
-- Host: 127.0.0.1
-- Generation Time: 2018-05-01 06:58:29
-- 服务器版本： 5.7.14
-- PHP Version: 5.6.25
...
(5, 1, 5, 'Weather', '今日天气', '今日天气', 0, 1, '3', 1, 1, 0, '{"app":{"id":"","name":"Weather","icon":"./static/apps/Weather/logo.png","title":"今日天气"},"desktopIcon":{"style":{"left":"","top":""}},"window":{"size":"custom","status":"close","type":"modal","enableResize":["custom","small","min","close"],"style":{"width":"280px","height":"350px","left":"calc(100% - 300px)","top":"20px"}},"taskBar":{"isPinned":true},"install":{"window":{"size":"custom","status":"close","type":"modal","enableResize":["custom","close"],"style":{"width":"400px","height":"300px","left":"calc(50% - 200px)","top":"calc(50% - 150px)"}},"taskBar":{"isPinned":false}},"uninstall":{"window":{"size":"custom","status":"close","type":"modal","enableResize":["custom","close"],"style":{"width":"400px","height":"300px","left":"calc(50% - 200px)","top":"calc(50% - 150px)"}},"taskBar":{"isPinned":false}}}', '2018-04-26 07:40:54', '2018-04-26 07:40:54'),
(6, 1, 6, 'Weixin', '微信', '微信网页版', 0, 1, '2', 1, 1, 0, '{"app":{"id":"","name":"Weixin","icon":"./static/apps/Weixin/logo.png","title":"微信"},"desktopIcon":{"style":{"left":"","top":""}},"window":{"size":"custom","status":"close","type":"modal","enableResize":["custom","small","min","max","middle","reset","close"],"style":{"width":"1000px","height":"600px","left":"calc(50% - 500px)","top":"calc(50% - 300px)"}},"taskBar":{"isPinned":true},"install":{"window":{"size":"custom","status":"close","type":"modal","enableResize":["custom","close"],"style":{"width":"400px","height":"300px","left":"calc(50% - 200px)","top":"calc(50% - 150px)"}},"taskBar":{"isPinned":false}},"uninstall":{"window":{"size":"custom","status":"close","type":"modal","enableResize":["custom","close"],"style":{"width":"400px","height":"300px","left":"calc(50% - 200px)","top":"calc(50% - 150px)"}},"taskBar":{"isPinned":false}}}', '2018-04-27 14:51:29', '2018-04-27 14:51:29'),
(7, 1, 7, 'XPlayer', 'XPlayer', '视频播放器', 0, 1, '', 1, 1, 0, '{"app":{"id":"","name":"XPlayer","icon":"./static/apps/XPlayer/logo.png","title":"XPlayer"},"desktopIcon":{"style":{"left":"","top":""}},"window":{"size":"custom","status":"close","type":"modal","enableResize":["custom","small","min","max","middle","reset","close"],"style":{"width":"630px","height":"460px","left":"calc(50% - 315px)","top":"calc(50% - 230px)"}},"taskBar":{"isPinned":true},"install":{"window":{"size":"custom","status":"close","type":"modal","enableResize":["custom","close"],"style":{"width":"400px","height":"300px","left":"calc(50% - 200px)","top":"calc(50% - 150px)"}},"taskBar":{"isPinned":false}},"uninstall":{"window":{"size":"custom","status":"close","type":"modal","enableResize":["custom","close"],"style":{"width":"400px","height":"300px","left":"calc(50% - 200px)","top":"calc(50% - 150px)"}},"taskBar":{"isPinned":false}}}', '2018-04-30 13:38:30', '2018-04-30 13:38:30');
...
--
ALTER TABLE `platform_apps`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '应用ID', AUTO_INCREMENT=8;
--
